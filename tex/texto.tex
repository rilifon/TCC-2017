...
\nome{Ricardo Lira da Fonseca}
\titulo{PsyChO: The Ball}
\mestrado{Ciência da Computação}
%\doutorado{Matemática}
\orientador{Prof. Dr. Flávio Soares Corrêa da Silva}{IME-USP}

\datadeposito{dezembro de 2017} % data do deposito
